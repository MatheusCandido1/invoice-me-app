        ...
        <section className="w-full flex justify-center flex-col mt-2 p-8 w-full">
          <div className="flex">
                    ...
                    <div className="flex w-full px-3 my-2 flex-col gap-2">
                      <button onClick={handleLoginClick} type="button" className="w-full bg-primary-main text-white hover:bg-primary-dark flex items-center justify-center font-semibold rounded-xl text-sm h-10 rounded">Entrar</button>
