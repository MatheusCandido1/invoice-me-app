    ...
    <Panel width="w-3/6" height="h-full">
      ...
      <section className="w-full flex flex-col p-4 gap-4">
        <div className="flex gap-4 w-full">
          <div className="w-1/2 hover:text-white hover:bg-primary-main cursor-pointer text-primary-main flex border-2 border-primary-main rounded-lg px-2 h-16 justify-center items-center flex-col">
            <BiWallet size={26} />
            <p className=" font-semibold">Contas</p>
          </div>
          <div className="w-1/2 hover:text-white hover:bg-primary-main cursor-pointer flex border-2 text-primary-main border-primary-main rounded-lg px-2 h-16 justify-center items-center flex-col">
            <BiUserPlus size={26}  />
